<template>
  <!-- component -->
  <div
    class="antialiased w-full h-full bg-gray-700 text-gray-400 font-inter p-10 rounded-lg"
  >
    <div class="container px-4 mx-auto">
      <div>
        <div id="title" class="text-center my-2">
          <h1 class="font-bold text-4xl text-white">Pricing Plans</h1>
          <p class="text-light text-gray-500 text-xl">Here are our pricing plans</p>
        </div>
        <div
